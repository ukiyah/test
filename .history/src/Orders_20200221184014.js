...
const rows = [
  createData(0, '1月31日', '株式会社ABC', 'メディカルクラッチ'),
  createData(1, '2月2日', '株式会社ABC', 'メディカルクラッチ'),
  createData(2, '2月4日', '株式会社ABC', 'メディカルクラッチ'),
  createData(3, '2月8日', '株式会社ABC', 'メディカルクラッチ'),
  createData(4, '2月10日', '株式会社ABC', 'メディカルクラッチ'),
];
