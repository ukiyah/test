...
import form_closing from "./closing/form_closing";
import weekly_report from "./weekly_report/weekly_report";
      ...
      <div>
        ...
        <BrowserRouter>
          <div>
            ...
            <Route path="/form_arrange_interview" component={form_arrange_interview} />
            <Route path="/form_confirm_interview" component={form_confirm_interview} />
            <Route path="/form_complete_interview" component={form_complete_interview} />
            <Route path="/weekly_report" component={weekly_report} />
            <Route path="/form_closing" component={form_closing} />
         </div>
        </BrowserRouter>
        {/* <ClippedDrawer /> */}
      </div>
