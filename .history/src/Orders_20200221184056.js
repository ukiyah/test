...
const rows = [
  createData(0, '1月31日', '株式会社ABC', 'テクノプロップス'),
  createData(1, '2月2日', '株式会社ABC', 'テクノプロップス'),
  createData(2, '2月4日', '株式会社ABC', 'テクノプロップス'),
  createData(3, '2月8日', '株式会社ABC', 'テクノプロップス'),
  createData(4, '2月10日', '株式会社ABC', 'テクノプロップス'),
];
