      ...
      <ExpansionPanel defaultExpanded>
        ...
        <ExpansionPanelDetails>
          <Typography >
            ...
            {/* </div> */}
            <div style={{display:"flex"}} >
              <Button disableElevation variant="contained" color="secondary">1日後</Button>
              <Button disableElevation variant="contained" color="secondary">2日後</Button>
              <Button disableElevation variant="contained" color="secondary">3日後</Button>
              <Button disableElevation variant="contained" color="secondary">4日後</Button>
              <Button disableElevation variant="contained" color="secondary">5日後</Button>
            </div>
            <br></br>
