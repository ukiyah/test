...
function createData(closing_date,  upper_side, lower_side, sales, costs, margin, working_period) {
  return { closing_date,  upper_side, lower_side, sales, costs, margin, working_period};
}

const rows = [
  createData('2020/02/15', 'ABC産業', 'CCDテクノロジー', 80, 65, 15 ),
  createData('2020/02/15', 'ABC産業', 'CCDテクノロジー', 80, 65, 15),
  createData('2020/02/15', 'ABC産業', 'CCDテクノロジー', 80, 65, 15),
  createData('2020/02/15', 'ABC産業', 'CCDテクノロジー', 80, 65, 15),
  createData('2020/02/15', 'ABC産業', 'CCDテクノロジー', 80, 65, 15),
